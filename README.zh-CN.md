...
本地 **v1.0.45 候选版本**完善了并发配置保存和凭据恢复，修复了概览轮询中的进度状态，并优化了编辑保存保护、资产预览恢复、键盘操作和减少动态效果。详见[版本说明](docs/release-notes/v1.0.45.md)和[架构与 UI/UX 审查记录](docs/audits/2026-09-12-architecture-uiux.md)。
