...
test('release metadata builds the public stable update manifest', () => {
  ...
  assert.deepEqual(manifest, {
    ...
    publishedAt: '2026-03-26T00:00:00.000Z',
    releaseNotes: '',
    releaseNotesUrl: 'https://github.com/langlink-localization/memoq-ai-hub/releases/tag/v1.0.3',
    assets: {
      portable: {
        name: PORTABLE_WINDOWS_ARTIFACT_NAME,
        url: 'https://github.com/langlink-localization/memoq-ai-hub/releases/download/v1.0.3/memoq-ai-hub-win32-x64.zip'
      },
      installer: {
        name: INSTALLER_WINDOWS_ARTIFACT_NAME,
        url: 'https://github.com/langlink-localization/memoq-ai-hub/releases/download/v1.0.3/memoQ-AI-Hub-Setup.exe'
      }
    }
  });
});
