...
export function parseTimestampToEpochMs(value) {
...
export function parseDateInputToEpochMs(value, options = {}) {
  const text = String(value || '').trim();
  if (!text) {
    return null;
  }
...
export function formatTimestampForLocalDisplay(value, options = {}) {
