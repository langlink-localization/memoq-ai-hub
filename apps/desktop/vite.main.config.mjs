  ...
  build: {
    rolldownOptions: {
      ...
      input: {
        ...
        'runtime/runtimeAggregationService': path.resolve(__dirname, 'src/runtime/runtimeAggregationService.js'),
        'runtime/runtimeAssetService': path.resolve(__dirname, 'src/runtime/runtimeAssetService.js'),
        'runtime/runtimeAssetTbService': path.resolve(__dirname, 'src/runtime/runtimeAssetTbService.js'),
        ...
        'runtime/runtimeHistoryPresentation': path.resolve(__dirname, 'src/runtime/runtimeHistoryPresentation.js'),
        'runtime/runtimeStateView': path.resolve(__dirname, 'src/runtime/runtimeStateView.js'),
        ...
        'runtime/previewSnapshotSettle': path.resolve(__dirname, 'src/runtime/previewSnapshotSettle.js'),
        ...
        'runtime/runtimeQaHistoryService': path.resolve(__dirname, 'src/runtime/runtimeQaHistoryService.js'),
        ...
        'runtime/runtimeTranslationService': path.resolve(__dirname, 'src/runtime/runtimeTranslationService.js'),
        ...
        'shared/promptPresets': path.resolve(__dirname, 'src/shared/promptPresets.js'),
        ...
        'provider/providerTransportSupport': path.resolve(__dirname, 'src/provider/providerTransportSupport.js'),
        ...
        'shared/appStateDefaults': path.resolve(__dirname, 'src/shared/appStateDefaults.js'),
        ...
        desktopTray: path.resolve(__dirname, 'src/desktopTray.js'),
        lifecycleSettings: path.resolve(__dirname, 'src/lifecycleSettings.js'),
        'integration/integrationService': path.resolve(__dirname, 'src/integration/integrationService.js'),
        mainSecretService: path.resolve(__dirname, 'src/mainSecretService.js'),
        ...
        secretBridge: path.resolve(__dirname, 'src/secretBridge.js'),
