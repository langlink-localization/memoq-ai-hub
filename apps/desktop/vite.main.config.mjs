  ...
  build: {
    rolldownOptions: {
      ...
      input: {
        ...
        'bilingual/bilingualFile': path.resolve(__dirname, 'src/bilingual/bilingualFile.js'),
        'bilingual/qaReport': path.resolve(__dirname, 'src/bilingual/qaReport.js'),
        ...
        'runtime/translationConfidence': path.resolve(__dirname, 'src/runtime/translationConfidence.js'),
        ...
        'qa/aiQualityChecker': path.resolve(__dirname, 'src/qa/aiQualityChecker.js'),
